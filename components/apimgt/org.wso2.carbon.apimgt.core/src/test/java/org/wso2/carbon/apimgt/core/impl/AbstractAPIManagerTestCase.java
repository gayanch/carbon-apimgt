...
public class AbstractAPIManagerTestCase {
    ...
    private APIStoreImpl getAPIStoreImpl(APISubscriptionDAO apiSubscriptionDAO) {
        return new APIStoreImpl(USER_NAME, null, null, null, null, apiSubscriptionDAO, null, null, null, null, null,
                null, null);
    }
    ...
    private APIPublisherImpl getApiPublisherImpl(ApiDAO apiDAO) {
        return new APIPublisherImpl(USER_NAME, null, null, apiDAO, null, null, null, null, null, null, null, null,
    ...
    private APIPublisherImpl getApiPublisherImpl(LabelDAO labelDAO) {
        return new APIPublisherImpl(USER_NAME, null, null, null, null, null, null, null, labelDAO, null, null, null,
                new GatewaySourceGeneratorImpl(), new APIGatewayPublisherImpl());
    }

    private APIPublisherImpl getApiPublisherImpl(PolicyDAO policyDAO) {
        return new APIPublisherImpl(USER_NAME, null, null, null, null, null, policyDAO, null, null, null, null, null,
                new GatewaySourceGeneratorImpl(), new APIGatewayPublisherImpl());
    }

    private APIPublisherImpl getApiPublisherImpl(APISubscriptionDAO apiSubscriptionDAO) {
        return new APIPublisherImpl(USER_NAME, null, null, null, null, apiSubscriptionDAO, null, null, null, null, null, null,
                new GatewaySourceGeneratorImpl(), new APIGatewayPublisherImpl());
    }

    private APIPublisherImpl getApiPublisherImpl(IdentityProvider identityProvider) {
        return new APIPublisherImpl(USER_NAME, identityProvider, null, null, null, null, null, null, null, null, null, null,
                new GatewaySourceGeneratorImpl(), new APIGatewayPublisherImpl());
    }
}
