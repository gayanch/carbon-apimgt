...
public class APIMgtConstants {
    ...
    public static class GatewayEventTypes {
        ...
        public static final String THREAT_PROTECTION_JSON_POLICY_ADD = "THREAT_PROTECTION_JSON_POLICY_ADD";
        public static final String THREAT_PROTECTION_JSON_POLICY_DELETE = "THREAT_PROTECTION_JSON_POLICY_DELETE";
        public static final String THREAT_PROTECTION_JSON_POLICY_UPDATE = "THREAT_PROTECTION_JSON_POLICY_UPDATE";
        public static final String THREAT_PROTECTION_XML_POLICY_ADD = "THREAT_PROTECTION_XML_POLICY_ADD";
        public static final String THREAT_PROTECTION_XML_POLICY_DELETE = "THREAT_PROTECTION_XML_POLICY_DELETE";
        public static final String THREAT_PROTECTION_XML_POLICY_UPDATE = "THREAT_PROTECTION_XML_POLICY_UPDATE";
    }
